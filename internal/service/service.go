...
type AssessmentService interface {
	...
	// GetFinalGradesByClassID busca as notas finais de uma turma.
	GetFinalGradesByClassID(ctx context.Context, classID int64) ([]models.Student, map[int64]float64, error)
}
