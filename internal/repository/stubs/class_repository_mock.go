...
//
//	mockgen -source=repository.go -destination=stubs/class_repository_mock.go -package=stubs ClassRepository
//
...
// GetUpcomingActiveTasks mocks base method.
func (m *MockTaskRepository) GetUpcomingActiveTasks(ctx context.Context, userID int64, fromDate time.Time, limit int) ([]models.Task, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUpcomingActiveTasks", ctx, userID, fromDate, limit)
	ret0, _ := ret[0].([]models.Task)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUpcomingActiveTasks indicates an expected call of GetUpcomingActiveTasks.
func (mr *MockTaskRepositoryMockRecorder) GetUpcomingActiveTasks(ctx, userID, fromDate, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUpcomingActiveTasks", reflect.TypeOf((*MockTaskRepository)(nil).GetUpcomingActiveTasks), ctx, userID, fromDate, limit)
}
...
// MockLessonRepository is a mock of LessonRepository interface.
type MockLessonRepository struct {
	ctrl     *gomock.Controller
	recorder *MockLessonRepositoryMockRecorder
	isgomock struct{}
}

// MockLessonRepositoryMockRecorder is the mock recorder for MockLessonRepository.
type MockLessonRepositoryMockRecorder struct {
	mock *MockLessonRepository
}

// NewMockLessonRepository creates a new mock instance.
func NewMockLessonRepository(ctrl *gomock.Controller) *MockLessonRepository {
	mock := &MockLessonRepository{ctrl: ctrl}
	mock.recorder = &MockLessonRepositoryMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockLessonRepository) EXPECT() *MockLessonRepositoryMockRecorder {
	return m.recorder
}

// CreateLesson mocks base method.
func (m *MockLessonRepository) CreateLesson(ctx context.Context, lesson *models.Lesson) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateLesson", ctx, lesson)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockLessonRepositoryMockRecorder) CreateLesson(ctx, lesson any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateLesson", reflect.TypeOf((*MockLessonRepository)(nil).CreateLesson), ctx, lesson)
}

// DeleteLesson mocks base method.
func (m *MockLessonRepository) DeleteLesson(ctx context.Context, lessonID int64) error {
	m.ctrl.T.Helper()
...
func (mr *MockLessonRepositoryMockRecorder) DeleteLesson(ctx, lessonID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteLesson", reflect.TypeOf((*MockLessonRepository)(nil).DeleteLesson), ctx, lessonID)
}

// GetLessonByID mocks base method.
func (m *MockLessonRepository) GetLessonByID(ctx context.Context, lessonID int64) (*models.Lesson, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLessonByID", ctx, lessonID)
	ret0, _ := ret[0].(*models.Lesson)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLessonByID indicates an expected call of GetLessonByID.
func (mr *MockLessonRepositoryMockRecorder) GetLessonByID(ctx, lessonID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLessonByID", reflect.TypeOf((*MockLessonRepository)(nil).GetLessonByID), ctx, lessonID)
}

// GetLessonsByClassID mocks base method.
func (m *MockLessonRepository) GetLessonsByClassID(ctx context.Context, classID int64) ([]models.Lesson, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLessonsByClassID", ctx, classID)
	ret0, _ := ret[0].([]models.Lesson)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLessonsByClassID indicates an expected call of GetLessonsByClassID.
func (mr *MockLessonRepositoryMockRecorder) GetLessonsByClassID(ctx, classID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLessonsByClassID", reflect.TypeOf((*MockLessonRepository)(nil).GetLessonsByClassID), ctx, classID)
}

// GetLessonsByDateRange mocks base method.
func (m *MockLessonRepository) GetLessonsByDateRange(ctx context.Context, userID int64, startDate, endDate time.Time) ([]models.Lesson, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLessonsByDateRange", ctx, userID, startDate, endDate)
	ret0, _ := ret[0].([]models.Lesson)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLessonsByDateRange indicates an expected call of GetLessonsByDateRange.
func (mr *MockLessonRepositoryMockRecorder) GetLessonsByDateRange(ctx, userID, startDate, endDate any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLessonsByDateRange", reflect.TypeOf((*MockLessonRepository)(nil).GetLessonsByDateRange), ctx, userID, startDate, endDate)
}

// UpdateLesson mocks base method.
func (m *MockLessonRepository) UpdateLesson(ctx context.Context, lesson *models.Lesson) error {
	m.ctrl.T.Helper()
...
func (mr *MockLessonRepositoryMockRecorder) UpdateLesson(ctx, lesson any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateLesson", reflect.TypeOf((*MockLessonRepository)(nil).UpdateLesson), ctx, lesson)
}
